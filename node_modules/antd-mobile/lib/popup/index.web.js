...
function create(instanceId, config, content) {
    ...
    _reactDom2['default'].render(_react2['default'].createElement(
        _rcDialog2['default'],
        (0, _extends3['default'])({}, props, { className: cls, visible: true, title: '', footer: '', transitionName: transitionName || transName, maskTransitionName: maskTransitionName || 'am-fade', maskProps: (0, _objectAssign2['default'])({}, props.maskProps, maskProps) }),
        content
    ), div);
    return {
