...
function create(instanceId, config, content) {
    ...
    ReactDOM.render(React.createElement(
        Dialog,
        _extends({}, props, { className: cls, visible: true, title: '', footer: '', transitionName: transitionName || transName, maskTransitionName: maskTransitionName || 'am-fade', maskProps: assign({}, props.maskProps, maskProps) }),
        content
    ), div);
    return {
